  ...
  <div class="container-1200 d-flex gap-24">
    ...
    <section class="flex-1">
      <div class="card-white p-20">
        <h3 class="fw-700 text-navy mb-4">📘 교수 시간표</h3>

        <!-- ✅ 기존 타임테이블 내용 (절대 수정 금지) -->
        <div class="container">
          <!-- 요일 / 교시 / 시간 매핑 -->
                ...
                <tr>
                  ...
                  <c:forEach var="day" items="${days}">
                    <td>
                      ...
                      <%-- 1. 현재 교시 시작 시간을 숫자 형태로 변환 (예: 09:00 -> 0900) --%>
                      ...
                      <c:forEach var="course" items="${courses}">
                        <c:if test="${course.dayOfWeek eq day}">
                          ...
                          <%-- 2. 강의 시작 시간을 숫자 형태로 변환 (예: 09:00 -> 0900) --%>
                          <c:set var="startNum" value="${fn:replace(start, ':', '')}"/>

                          <%-- 3. 숫자 값을 기준으로 현재 교시가 강의의 '시작 교시'인지 정확히 일치 비교 --%>
