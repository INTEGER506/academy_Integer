...
<jsp:include page="/WEB-INF/views/common/searchBar.jsp">
    ...
    <jsp:param name="placeHolder"     value="학생 이름, 학번, 과목명 검색"/>
    <jsp:param name="optionValues"    value="name|studentNo|subject"/>
    <jsp:param name="optionLabels"    value="이름|학번|과목명"/>
    <jsp:param name="pageSizeOptions" value="5|10|15|20"/>
    <jsp:param name="keep"            value='<input type="hidden" name="professorId" value="${professorId}"/>'/>
</jsp:include>
<%-- 목록 테이블 --%>
