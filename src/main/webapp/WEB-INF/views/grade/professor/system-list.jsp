...
<jsp:include page="/WEB-INF/views/common/searchBar.jsp">
    ...
    <jsp:param name="placeHolder"     value="비율명 검색"/>
    <jsp:param name="optionValues"    value="midExamRatio|finalExamRatio|assignmentRatio|attendanceRatio"/>
    <jsp:param name="optionLabels"    value="중간|기말|과제|출석"/>
    <jsp:param name="pageSizeOptions" value="5|10|20"/>
    <jsp:param name="keep"            value='<input type="hidden" name="courseId" value="${courseId}"/>'/>
</jsp:include>
