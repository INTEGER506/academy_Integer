...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="btn-group">
                <a href="${pageContext.request.contextPath}/grade/admin/rule/global" class="btn btn-primary">글로벌 성적 규정 목록 (인라인 편집)</a>
        ...
        <div class="section">
            ...
            <div class="btn-group">
                ...
                <a href="${pageContext.request.contextPath}/grade/professor/list?professorId=1&courseId=1&subjectId=1" class="btn btn-success">강의별 성적 관리 (인라인 등록)</a>
        ...
        <div class="section">
            ...
            <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; font-family: monospace;">
                <div>• 관리자 글로벌 규정: <code>/grade/admin/rule/global</code> (인라인 편집)</div>
