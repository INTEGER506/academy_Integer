    ...
    <div class="container-1200 d-flex gap-24">
        ...
        <section class="flex-1 d-flex flex-column gap-24">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="fw-bold mb-0">새 학사일정 추가</h4>
                ...
                <form id="addForm" class="d-flex flex-column gap-3">
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" id="content" name="content" class="form-control" placeholder="예: 2학기 개강" required>
                        </div>
                    ...
                    <div class="mt-4 d-flex gap-2 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-navy rounded-pill px-4">저장</button>
                    </div>
                </form>
            </div>
        </section>
        ...
        $('#addForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    alert(response || "일정이 성공적으로 저장되었습니다.");
                    location.href = '/calendar/list';
                },
                error: function(xhr) {
                    let msg = '일정 저장 중 오류가 발생했습니다.';
                    if (xhr.status === 403) {
                        msg = '권한이 없습니다. 교직원/관리자만 등록 가능합니다.';
