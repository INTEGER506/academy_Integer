...
public class GradeRestController {
    ...
    public ResponseEntity<PageResponseDTO<GradeSystem>> listSystem(@RequestParam Long courseId, PageRequestDTO req){
        return ResponseEntity.ok(gradeService.listGradeSystemByCourse(courseId, req));
    }
    /*================================학생================================*/
    // 학생 성적 목록
